...
parser.add_argument('--data', default='music', help='name of dataset')
...
if with_bert:
  bert_sentence_embedding = torch.load("../BERT/music_train_sentence.pt")

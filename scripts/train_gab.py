...
parser.add_argument('--data', default='gab', help='name of dataset')
...
if with_bert:
  bert_sentence_embedding = torch.load("../BERT/gab_train_sentence.pt")
...
#model.load_state_dict(torch.load("ny_flow6_imdb_new/vae_11.bin"))
